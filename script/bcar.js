...
(async function() {
    const modApi = bcModSdk.registerMod({
        ...
        repository: 'https://github.com/Bratfox/BCAR',
    });
    //global variables
    var Dictionary = [];
    ...
    function ActivityBeeper(type, nya) {
        ...
        ServerSend("ChatRoomChat", {
            ...
            Dictionary: [{
                Tag: "Beep",
                Text: CharacterNickname(Player) + typeAction[type][1][nya]
            }]
        });
    ...
    async function bcarSettingsLoad() {
        ...
        const BCAR_DEFAULT_SETTINGS = {
            ...
            genderDefault: {
                "capPronoun": "She", //Capitalized Pronoun (He, She, They)
                "pronoun": "she", //Pronoun (he, she, they)
                "intensive": "her", //Intensive (him, her, them)
                "possessive": "her", //Possessive (his, her, their)
                "gender": "Female", //Output for the status page
            },
            profile1Saved: false,
            profile1: {
                earWigglingEnable: false,
